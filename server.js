...
app.listen(config.get('port'),()=>{
    ...
    app.get('/api/articless', function(req, res) {
        res.send('This is not implemented now');
        });
        app.post('/api/articless', function(req, res) {
           res.send('This is not implemented now');
        });
        app.get('/api/articless/:id', function(req, res) {
        res.send('This is not implemented now');
        });
        app.put('/api/articless/:id', function (req, res){
        res.send('This is not implemented now');
        });
        app.delete('/api/articless/:id', function (req, res){
        res.send('This is not implemented now');
        });